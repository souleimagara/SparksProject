...
namespace Beamable.Examples.Prefabs.LeaderboardFlow.LeaderboardFlowInterpolationExample
{
    ...
    public class LeaderboardFlowInterpolationExample : MonoBehaviour
    {
        ...
        private async void SetupBeamable()
        {
            ...
            //int leaderboardRowCountMin = 3;
            //int leaderboardScoreMin = 1;
            //int leaderboardScoreMax = 10;
            ...
            //leaderboardStats.Add("leaderboard_score_velocity", 01); // 99 score delta per second
